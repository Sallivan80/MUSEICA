///////////////////////////////////////////////////////////
//  RicercaCliente.cs
//  Implementation of the Class RicercaCliente
//  Generated by Enterprise Architect
//  Created on:      04-ott-2014 16.09.19
...
namespace MUSEICA.Model
{
    public class RicercaCliente : IRicercaProvider
    {
        ...
        public List<Prenotazione> Ricerca(List<Prenotazione> prenotazioni)
        {
            ...
            {
                if (_clienteToFind.Cognome.ToLower().Equals(p.Cliente.Cognome.ToLower()) && _clienteToFind.Nome.ToLower().Equals(p.Cliente.Nome.ToLower()))
                    result.Add(p);
            }
