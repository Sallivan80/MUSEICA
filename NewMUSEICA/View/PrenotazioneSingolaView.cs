...
namespace NewMUSEICA.View
{
    public partial class PrenotazioneSingolaView : Form
    {
        ...
        private void SetValueModificaMode(PrenotazioneSingola selectedPrenotazione)
        {
            ...
            SetValueDataOreModificaMode(selectedPrenotazione.Data,selectedPrenotazione.OraInizio,selectedPrenotazione.OraFine);
            _textBoxNote.Text = selectedPrenotazione.Note;
        }
